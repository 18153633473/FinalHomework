...
public class classify extends Activity implements AdapterView.OnItemLongClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(RateItem item : manager.listAll()) {
            ...
            int type=Integer.parseInt(menu);
            if (a == type) {
                try {
        ...
        list = (ListView) findViewById(R.id.classifylv);
    ...
    public void showUsualDialog() {
        ...
        dialog2 = UsualDialogger.Builder(this)
                ...
                .setOnConfirmClickListener("确定", view -> {
                    Toast.makeText(classify.this, "确定", Toast.LENGTH_SHORT).show();
                ...
                .setOnCancelClickListener("取消", view -> {
                    Toast.makeText(classify.this, "取消", Toast.LENGTH_SHORT).show();
                    if (dialog2 != null) {
                        dialog2.dismiss();
                    }
                })
